...
const submit = () => {
  form.post('/visiteur/connexion');
};

const redirectToRegister = () => {
  router.get(route('visiteur.inscription')); // Assuming you have a route named 'visiteur.inscription'
};
</script>
...
.register-tab {
    color: #007bff; /* Couleur distinctive pour "Inscription" */
}
