...
/* Ajout du style pour le bouton "Nouvelle Conversation" */
.new-chat-button-container {
    text-align: center; /* Centrer le bouton */
    margin-bottom: 15px; /* Espacement sous le conteneur du bouton */
}
...
.plus-icon {
    font-size: 1.2em; /* Taille de l'icône plus */
    line-height: 1; /* Ajuster la hauteur de ligne pour centrer verticalement */
}


/* Media Queries pour Responsive Design - Page Chat (avec bouton Nouvelle Conversation) */
...
@media (max-width: 768px) { /* Styles pour les écrans de tablette et mobiles */
    ...
    .new-chat-button-container {
        margin-bottom: 10px; /* Réduire la marge du bouton "Nouvelle Conversation" sur mobile */
    }

    .new-chat-button {
        font-size: 0.95em; /* Réduire la taille de police du bouton sur mobile */
        padding: 8px 12px; /* Réduire le padding du bouton sur mobile */
    }
...
@media (max-width: 576px) { /* Styles pour les petits mobiles - ajustements optionnels */
    ...
    .new-chat-button {
        font-size: 0.9em; /* Réduire encore un peu la taille de police du bouton sur très petits mobiles */
        padding: 6px 10px; /* Réduire encore un peu le padding du bouton sur très petits mobiles */
    }
}
    </style>
